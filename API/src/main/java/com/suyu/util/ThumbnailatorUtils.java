...
public class ThumbnailatorUtils {
     ...
     */
    public static BufferedImage ImgBufferedImage(BufferedImage bufferedImage, String output, int width, int height, String format) {
        BufferedImage buf = null;
        try {
            buf = Thumbnails.of(bufferedImage).size(width, height).keepAspectRatio(false).asBufferedImage();
     ...
     * @return
     */
    public static InputStream ImgBufferedImage(InputStream inputStream, String output, int width, int height, String format) {
        BufferedImage buf = null;
        try {
            buf = Thumbnails.of(inputStream).size(width, height).keepAspectRatio(false).asBufferedImage();
            ImageIO.write(buf, format, new File(output));
    ...
    public static void main(String[] args) {
        ThumbnailatorUtils.ImgNoScale(new File("D:/sign/nie.png"),"D:/sign/nie2.png",300,150,false);
    }
}
